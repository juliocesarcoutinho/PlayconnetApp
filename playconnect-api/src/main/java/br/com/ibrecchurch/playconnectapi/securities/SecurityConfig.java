    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource())) // Adiciona suporte a CORS
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/usuarios").hasAnyAuthority("ADMINISTRADOR", "GERENTE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/usuarios").hasAnyAuthority("ADMINISTRADOR", "GERENTE", "OPERADOR")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/usuarios/**").hasAnyAuthority("ADMINISTRADOR", "GERENTE", "OPERADOR")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/roles/**").hasAnyAuthority("ADMINISTRADOR", "GERENTE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/usuarios/{id}").hasAnyAuthority("ADMINISTRADOR", "GERENTE", "OPERADOR")
                        .requestMatchers(HttpMethod.GET, "/api/v1/ceps/**").hasAnyAuthority("ADMINISTRADOR", "GERENTE", "OPERADOR")

...
const EditarUsuario: React.FC<EditarUsuarioProps> = ({setUsuarios, usuario, isOpen, onHide, onUpdate}) => {
    ...
    const validarCamposObrigatorios = () => {
        const erros = {
            ...
            celular: !usuarioSelecionado?.celular?.trim(),
        };
            ...
            <Dialog visible={isOpen}
                ...
                <div className="p-fluid formgrid grid">
                    ...
                    <div className="field col-12 md:col-6">
                        ...
                        <InputMask id="celular" value={usuarioSelecionado.celular}
                                   onChange={(e) => onInputChange(e, 'celular')}
                                   mask="(99)99999-9999" placeholder="Informe o celular"/>
                        {validationError.celular && <small className="p-error">O celular é obrigatório</small>}
                    </div>
